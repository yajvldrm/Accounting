...
Public Class transcr
    ...
    Friend Sub formload()
        ...
        If main.Sys_Default.Rows(0)("line_currency") = 0 Then
            ...
            For Each obj As Control In det.Controls
                If Not TypeOf obj Is Button Then
                    obj.Top -= 23
                End If
            Next
            det.Height -= 23
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_cr_filter_new.journal_id = journal_id
        report_cr_filter_new.book_id = book_id
