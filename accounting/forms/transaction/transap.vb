...
Public Class transap
    ...
    Friend Sub formload()
        ...
        If main.Sys_Default.Rows(0)("line_currency") = 0 Then
            ...
            txtcurrencydet.AlwaysDisable = True
            txtexchangeratedet.AlwaysDisable = True
            txtbasedratedet.AlwaysDisable = True
        End If
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        ...
        txtduedate.Text = DateTime.Today.ToString("MM/dd/yyyy")
        txtday.Text = Now().Day
    ...
    Private Sub txtgenlib_Leave(sender As Object, e As EventArgs) Handles txtgeneral.Leave
        general = FsQuery("select * from lib_erp_general WHERE general_type = 2 AND general_type = 3 ")
    ...
    Private Sub txtcurrency_Leave(sender As Object, e As EventArgs) Handles txtcurrency.Leave
        ...
        Else
            ...
            If Not dr Is Nothing Then
                ...
                txtcurrencydet.Text = dr("currency_name")
    ...
    Private Sub txtcurrencydet_Leave(sender As Object, e As EventArgs) Handles txtcurrencydet.Leave
        ...
        Else
            ...
            If currency.Rows.Count = 1 Then
                dr = currency.Rows(0)
            Else
                Dim dra() As DataRow = currency.Select("currency_name like '" & txtcurrencydet.Text.ToString.Replace("'", "''") & "'")
                If dra.Count > 0 Then
                    dr = dra(0)
                Else
                    browse.dt = currency
    ...
    Private Sub ValidateEntry(Optional dnref As Boolean = False)
        ...
        If Not txtaccount.RowData Is Nothing Then
                ...
                Select Case v
                    ...
                    Case 3
                        If dnref Then
                            ...
                            offsetap.currency_id = txtcurrencydet.Value
                    ...
                    Case 4 'EWT (credit)
                        ...
                        offsetewt.currency_id = txtcurrencydet.Value
                        ...
                        If offsetewt.ShowDialog() = DialogResult.OK Then
                            ...
                            If ds.Tables("ewt").Select("jbooks_id = '" & txtjbooksidtmp.Text & "' AND deleted = 'False'").Length > 0 Then
                                debit = ds.Tables("ewt").Compute("Sum(tax_amount)", "deleted = 'False' AND jbooks_id = '" & txtjbooksidtmp.Text & "'")
                            End If
                        Else
                            debit = 0
                            If ds.Tables("ewt").Select("jbooks_id = '" & txtjbooksidtmp.Text & "' AND deleted = 'False'").Length > 0 Then
                    ...
                    Case 5 'Final Tax (credit)
                        ...
                        offsetfinaltax.currency_id = txtcurrencydet.Value
                    ...
                    Case 6 'Input VAT (debit)
                        ...
                        setupinputvat.currency_id = txtcurrencydet.Value
                        setupinputvat.exchange_rate = txtexchangeratedet.DecimalValue
                        setupinputvat.based_rate = txtbasedratedet.DecimalValue
                    ...
                    Case 7
                        ...
                        offsetoutputvat.currency_id = txtcurrencydet.Value
                    ...
                    Case 8
                        ...
                        setupprepaid.currency_id = txtcurrencydet.Value
                        setupprepaid.exchange_rate = txtexchangeratedet.DecimalValue
                        setupprepaid.based_rate = txtbasedratedet.DecimalValue
                    ...
                    Case 9
                        ...
                        setupfixedasset.currency_id = txtcurrencydet.Value
                        setupfixedasset.exchange_rate = txtexchangeratedet.DecimalValue
                        setupfixedasset.based_rate = txtbasedratedet.DecimalValue
                ...
                Select Case v
                    Case 2
                        If dnref Then
                            ...
                            offsetar.currency_id = txtcurrencydet.Value
                    ...
                    Case 4
                        ...
                        setupewt.currency_id = txtcurrencydet.Value
                        setupewt.exchange_rate = txtexchangeratedet.DecimalValue
                        setupewt.based_rate = txtbasedratedet.DecimalValue
                    ...
                    Case 5
                        ...
                        setupfinaltax.currency_id = txtcurrencydet.Value
                        setupfinaltax.exchange_rate = txtexchangeratedet.DecimalValue
                        setupfinaltax.based_rate = txtbasedratedet.DecimalValue
                    ...
                    Case 6
                        ...
                        offsetinputvat.currency_id = txtcurrencydet.Value
                    ...
                    Case 8
                        ...
                        offsetprepaid.currency_id = txtcurrencydet.Value
                    ...
                    Case 7
                        ...
                        setupoutputvat.currency_id = txtcurrencydet.Value
                        setupoutputvat.exchange_rate = txtexchangeratedet.DecimalValue
                        setupoutputvat.based_rate = txtbasedratedet.DecimalValue
                    ...
                    Case 9
                        ...
                        offsetfixedasset.currency_id = txtcurrencydet.Value
            ...
            If "123456789".IndexOf(v.ToString) >= 0 Then
                Dim tmp_jbokksidtmp = txtjbooksidtmp.Text
                Dim tmp_id = txtcurrencydet.Value
                Dim tmp_text = txtcurrencydet.Text
                Dim tmp_xrate = txtexchangeratedet.DecimalValue
                Dim tmp_brate = txtbasedratedet.DecimalValue
                Me.Visible = True
                gridRowFocus(dgjbooks, {"jbooks_id_tmp", tmp_jbokksidtmp})
                txtcurrencydet.Value = tmp_id
                txtcurrencydet.Text = tmp_text
                txtexchangeratedet.DecimalValue = tmp_xrate
                txtbasedratedet.DecimalValue = tmp_brate
    ...
    Private Sub transap_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        Me.Top = ((Me.Parent.Height - Me.Height) / 2) - 2
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If Not txtsino.Text = "" Or Not txtrrno.Text = "" Or Not txtpono.Text = "" Or Not txtterms.Text = "" Or Not txtduedate.Text = "" Then
            ...
            Dim duedate As String = "0000-00-00"
            If Not txtduedate.Text = "" Then duedate = Format(Convert.ToDateTime(txtduedate.Text), "yyyy-MM-dd")
            fields.Add("due_date", IIf(duedate = "", Nothing, duedate))
            fields.Add("terms_id", txtterms.Value)
            fields.Add("nodays", txtnodays.DecimalValue)
            If txttransapid.Text = "" Then
    ...
    Friend Sub refresh_record()
        ...
        '    "left join " & connectionlib.connectionlib._serverDBFS & ".lib_erp_terms e on b.terms_id = e.terms_id " & _
        '    "where month(a.trans_date) = " & txtmonth.Value & _
        '    " and year(a.trans_date) = " & txtyear.Value & _
        '    " and journal_id = " & journal_id & " AND book_id = " & book_id)
        ...
        "WHERE MONTH(a.trans_date) = {1} AND YEAR(a.trans_date) = {2} AND journal_id = {3} AND book_id = {4}; " & _
        "", _serverDBFS, txtmonth.Value, txtyear.Value, journal_id, book_id, main.user_id)
        Dim dt As DataTable = Query(sql)
        ds.Tables("trans").Clear()
        For Each dr As DataRow In dt.Rows
            Dim newdr As DataRow = ds.Tables("trans").NewRow
            For Each dc As DataColumn In dt.Columns
                If ds.Tables("trans").Columns.Contains(dc.ColumnName) Then
                    newdr.Item(dc.ColumnName) = IIf(dr.Item(dc.ColumnName).ToString = "0000-00-00", DBNull.Value, dr(dc.ColumnName))
                End If
            Next
            ds.Tables("trans").Rows.Add(newdr)
        Next
        'For i = 0 To dt.Rows.Count - 1
        '    Dim dr As DataRow = ds.Tables("trans").NewRow
        '    For j = 0 To dt.Columns.Count - 1
        '        If dr.Table.Columns.Contains(dt.Columns(j).ColumnName) Then
        '            dr(dt.Columns(j).ColumnName) = IIf(dt.Rows(i)(dt.Columns(j).ColumnName).ToString = "0000-00-00", DBNull.Value, dt.Rows(i)(dt.Columns(j).ColumnName))
        '        End If
        '    Next
    ...
    Private Sub bind_control()
        ...
        For Each ctrl As Control In hdr.Controls
            If TypeOf (ctrl) Is user_control.textbox Then
                ...
                If txt.ValueSource <> "" Then
                    If txt.NumberFormat.Substring(0, 1) = "d" Then
                        txt.Value = Format(dr(txt.ValueSource), "d")
                    ElseIf txt.NumberFormat.Substring(0, 1) = "#" Then
                        txt.DecimalValue = dr(txt.ValueSource)
                    Else
                        txt.Value = dr(txt.ValueSource)
                    End If
                End If
                If txt.TextSource <> "" Then
                    If txt.NumberFormat.Substring(0, 1) = "d" Then
                        txt.Text = If(dr(txt.TextSource).ToString = "", "", Format(dr(txt.TextSource), "d"))
                    ElseIf txt.NumberFormat.Substring(0, 1) <> "#" Then
                        txt.Text = ifNull(dr(txt.TextSource), "")
                    End If
                End If
            End If
        Next
        ...
        'txtduedate.Text = Format(IIf(IsDBNull(dr("due_date")), Nothing, dr("due_date")), "MM/dd/yyyy")
        ...
        disable_control(dr("user_id").ToString = main.user_id, dr)
        currentDr = dr
        refresh_record_det()
    End Sub
    ...
    Private Sub bind_control_det()
        ...
        Else
            ...
            txtnodaysdet.Visible = False
        End If
        'txtchart_Leave(Nothing, Nothing)
        ...
        'txtcurrencyname.Text = dr("currency_name")
        'txtexchangeratedet.DecimalValue = dr("exchange_rate")
        'txtbasedratedet.DecimalValue = dr("based_rate")
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_ap_filter_new.journal_id = journal_id
        report_ap_filter_new.book_id = book_id
    ...
    Private Sub btnSettings_Click(sender As Object, e As EventArgs) Handles btnSettings.Click
        Dim dr As DataRow
        dr = main.Journal.Select("journal_code = 'AP'")(0)
        main.call_settings(dr)
    End Sub
    Private Sub transib_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        If transmode <> "" Then
