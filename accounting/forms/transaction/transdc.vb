...
Public Class transdc
    ...
    Private Sub enable_control()
        ...
        Dim dr As DataRow = main.Sys_Default_Det.Select("module_code = 'ACC00701'")(0)
    ...
    Private Sub txtgenlib_Leave(sender As Object, e As EventArgs) Handles txtgeneral.Leave
        general = FsQuery("select * from lib_erp_general WHERE general_type = 1 AND general_type = 3 ")
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        If ds.Tables("jbooks").Rows.Count > 0 Then
            txtamount.DecimalValue = ds.Tables("jbooks").Compute("sum(debit)", "")
            txtamountbased.DecimalValue = txtamount.DecimalValue * (txtexchangerate.DecimalValue / txtbasedrate.DecimalValue)
            txtamountwords.Text = amount_words(txtamount.DecimalValue)
        End If
        dgjbooks.DataSource = ds.Tables("jbooks")
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If ds.Tables("final_tax").Rows.Count > 0 Then
            For i = 0 To ds.Tables("final_tax").Rows.Count - 1
                ...
                Else
                    If dr("deleted").ToString = "True" Then
                        qry = String.Format("DELETE FROM trans_final_tax WHETE final_tax_id = {0}", dr("final_tax_id"))
                    Else
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_dc_filter_new.journal_id = journal_id
        report_dc_filter_new.book_id = book_id
        report_dc_filter_new.ShowDialog()
    End Sub
    ...
    Private Sub btnSettings_Click(sender As Object, e As EventArgs) Handles btnSettings.Click
        Dim dr As DataRow
        dr = main.Journal.Select("journal_code = 'DC'")(0)
