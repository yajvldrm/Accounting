...
Public Class transib
    ...
    Friend Sub formload()
        ...
        If main.Sys_Default.Rows(0)("line_currency") = 0 Then
            ...
            Me.Height -= 23
        End If
        If Not main.Sys_Default.Rows(0)("line_remarks") Then
    ...
    Private Sub transib_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        ...
        End If
    End Sub
    Private Sub transjb_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        formload()
    End Sub
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If Not txtdrno.Text = "" Or Not txtpono.Text = "" Or Not txtterms.Text = "" Or Not txtduedate.Text = "" Then
            'If Not txtdrno.Text = "" Or Not txtsino.Text = "" Or Not txtpono.Text = "" Or Not txtterms.Text = "" Or Not txtduedate.Text = "" Then
            qry = ""
    ...
    Friend Sub refresh_record()
        ...
        "WHERE MONTH(a.trans_date) = {1} AND YEAR(a.trans_date) = {2} AND journal_id = {3} AND book_id = {4}; " & _
            "", _serverDBFS, txtmonth.Value, txtyear.Value, journal_id, book_id)
    ...
    Private Sub bind_control()
        ...
        txttransibid.Text = dr("trans_ib_id")

        txtdrno.Text = dr("dr_no")
        'txtsino.Text = dr("si_no")
        txtpono.Text = dr("po_no")
        txtduedate.Text = String.Format("{0:d}", dr("due_date"))
        txtterms.Value = dr("terms_id").ToString
        txtterms.Text = dr("terms_name").ToString
        txtnodays.DecimalValue = dr("nodays").ToString
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_ib_filter_new.journal_id = journal_id
        report_ib_filter_new.book_id = book_id
        report_ib_filter_new.transid = txttransid.Text
        report_ib_filter_new.transno = txttransno.Text
    ...
    Private Sub btnSettings_Click(sender As Object, e As EventArgs) Handles btnSettings.Click
        Dim dr As DataRow
        dr = main.Journal.Select("journal_code = 'IB'")(0)
