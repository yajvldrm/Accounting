...
Public Class report_ap_filter
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        sql_header = String.Format("SELECT a.trans_id,a.trans_no,a.trans_date,b.currency_name,b.currency_code,a.amount,a.amount_based,a.exchange_rate,a.based_rate,a.description,a.general_id,c.general_code,c.general_name,c.address1 AS address,c.attention,IF(a.status = 'A','Approved',(IF(a.status = 'C','Cancelled',''))) AS status " & _
                                   ",d.due_date,d.si_no,d.rr_no,d.po_no,d.terms_id,d.nodays,e.terms_name " & _
                                       "FROM trans_header a " & _
                                       ...
                                       "LEFT JOIN {2}.trans_header_ap d ON d.trans_id = a.trans_id " & _
                                       "LEFT JOIN {1}.lib_erp_terms e ON e.terms_id = d.terms_id " & _
        ...
        sql_particular = String.Format("SELECT a.trans_particular_id,a.trans_id,a.trans_particular_code,a.trans_particular_name,a.trans_particular_amount " & _
        ...
        Select Case _print
            Case "1" ' Invoice
                ...
                If _currency = "1" Or _currency = "2" Then
                    ...
                    'rep.amount.DataBindings("Text").FormatString = "{0:" & frm & "}"
            ...
            Case "2" ' Invoice List
                Select Case _invoice
                    Case "1" ' By Invoice No
                        ...
                        Dim rep As New report_ap_print_2
                        rep.DataSource = ds
                    ...
                    Case "3" ' By Client
                        Select Case _client
                            Case "1" ' All Clients
                                ...
                                Dim rep As New report_ap_print_3
                                rep.DataSource = ds
                                rep.Parameters("runtime").Value = System.DateTime.Now.ToString("MM/dd/yyyy - HH:mm:ss")
