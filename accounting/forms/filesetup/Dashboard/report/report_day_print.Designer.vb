...
Partial Public Class report_day_print
    ...
    Private Sub InitializeComponent()
        ...
        Me.XrTableCell1.DataBindings.AddRange(New DevExpress.XtraReports.UI.XRBinding() {New DevExpress.XtraReports.UI.XRBinding("Text", Nothing, "trans_date", "{0:dd-MMM-yy}")})
        ...
        Me.print_title_header.Text = "Sales Per Day"
