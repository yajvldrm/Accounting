...
Public Class report_apsummary_print_1
    Private Sub noNegative1(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrTableCell21.BeforePrint
        ...
        End If
    End Sub
    Private Sub noNegative1(sender As Object, e As TextFormatEventArgs) Handles XrTableCell5.SummaryCalculated, XrTableCell6.SummaryCalculated, XrTableCell21.SummaryCalculated
        Dim lbl = CType(sender, XRLabel)
