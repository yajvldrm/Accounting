...
Public Class ardetailedaging
    Private module_code As String = "ACC01005"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click, btnExcel.Click
        ...
        Dim _name As String = "DETAILED AGING OF ACCOUNTS RECEIVABLE"
        ...
        Else
            Try
                ...
                dicHeader.Add("reportName", "Detailed Aging of Accounts Receivable")
                ...
                For Each detail In item.Item("datas")
                    ...
                    If Currency = "2" And WithComparison Then
                        If showBookCode.Checked Then
                            ...
                            xlWorkSheet.Cells(CurrentRow, 5).Value = detail.Item("debit")
                            xlWorkSheet.Cells(CurrentRow, 6).Value = detail.Item("exchange_rate")
                            xlWorkSheet.Cells(CurrentRow, 7).Value = detail.Item("debit_based")
                        ...
                        Else
                            ...
                            xlWorkSheet.Cells(CurrentRow, 4).Value = detail.Item("debit")
                            xlWorkSheet.Cells(CurrentRow, 5).Value = detail.Item("exchange_rate")
                            xlWorkSheet.Cells(CurrentRow, 6).Value = detail.Item("debit_based")
