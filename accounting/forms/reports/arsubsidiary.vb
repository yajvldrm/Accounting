...
Public Class arsubsidiary
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click, btnExcel.Click
        ...
        Select Case account
            ...
            Case "2"
                Dim sql_account_id As String = String.Format("SELECT GROUP_CONCAT(a.account_id) AS account_id " &
                    ...
                    "WHERE b.validation = '2' AND a.user_id = '{0}' AND c.module_code = '{1}'", main.user_id, module_code)
        ...
        col.Add(New KeyValuePair(Of String, String)("@validation", "2"))
        ...
        Dim newDS = ExecuteWithParameter("get_subsidiary_ledger", ConnectionStringFS, CommandType.StoredProcedure, col)
        Dim dt As DataTable = newDS
        ...
        If sender.name = "btnPrint" Then
            ...
            If wComparison And currency = "2" Then
                Dim rep As New report_arsubsidiary_print
                rep.DataSource = ds
            ...
            Else
                Dim rep As New report_arsubsidiary_print_1
                rep.DataSource = ds
                rep.Parameters("runtime").Value = System.DateTime.Now.ToString("MM/dd/yyyy - HH:mm:ss")
                rep.company_logo.ImageUrl = Application.StartupPath & "/img/logo.png"
                'rep.title.Text = _title
        ...
        Else
            Try
                ...
                End If
                dicHeader.Add("ReportName", "Subsidiary Ledger of Accounts Receivable")
            ...
            If TabSeparated Then
                For Each Book In ListAccount
                    ...
                    For Each Account In Book.Item("grouped")
                        ...
                        If Not NoRunningBalance Then
                            xlWorkSheet.Cells(CurrentRow, 9).Value = String.Format("=FIXED(IMSUB(G{0},H{0}),2)", CurrentRow)
                        ...
                        If WithComparison Then
                            ...
                            Else
                                ...
                                xlWorkSheet.Cells(CurrentRow, 12).Value = String.Format("=FIXED(IMSUB(J{0},K{0}),2)", CurrentRow)
                        ...
                        If NoRunningBalance Then
                            ...
                            xlWorkSheet.Cells(CurrentRow, 1).Font.Italic = True
                            xlWorkSheet.Cells(CurrentRow, 1).IndentLevel = 5
                            xlWorkSheet.Cells(CurrentRow, 8).Value = String.Format("=FIXED(IMSUB(G{0},H{0}),2)", CurrentRow - 1)
                            ExcelRange(xlWorkSheet, CurrentRow, 8).HorizontalAlignment = Excel.XlHAlign.xlHAlignRight
                            If WithComparison Then
                                xlWorkSheet.Cells(CurrentRow, 11).Value = String.Format("=FIXED(IMSUB(J{0},K{0}),2)", CurrentRow - 1)
                ...
                For Each Book In ListAccount
                    ...
                    If WithComparison Then
                        ...
                        Else
                            xlWorkSheet.Cells(CurrentRow, 10).Value = String.Format("=SUBTOTAL(9,J{0}:J{1})", FirstRow, CurrentRow - 2)
                            xlWorkSheet.Cells(CurrentRow, 11).Value = String.Format("=SUBTOTAL(9,K{0}:K{1})", FirstRow, CurrentRow - 2)
                            xlWorkSheet.Cells(CurrentRow, 12).Value = String.Format("=FIXED(IMSUB(J{0},K{0}))", CurrentRow)
                            ExcelRange(xlWorkSheet, CurrentRow, 12).HorizontalAlignment = Excel.XlHAlign.xlHAlignRight
                        End If
        ...
        For Each Item In ListAccount
            ...
            Else
                ...
                For Each Account In Item.Item("datas")
                    Dim particulars As String = If(ifNull(Account.Item("journal_id"), "8") = "8" And ifNull(Account.Item("description"), "") = "", "BEGINNING BALANCE", Account.Item("description"))
    ...
    Private Sub generateTabSeparatedDetailed(ByRef dic As Dictionary(Of String, Object), ByVal withUnit As Boolean)
        ...
        Else
            ...
            For Each i In listAccount
                Dim particulars As String = If(ifNull(i.Item("journal_id"), "8") = "8" And ifNull(i.Item("description"), "") = "", "BEGINNING BALANCE", i.Item("description"))
        ...
        For Each item In listAccount
            ...
            Else
                ...
                For Each d In listData
                    ...
                    End If
                    Dim particulars As String = If(ifNull(dic.Item("journal_id"), "8") = "8" And ifNull(dic.Item("description"), "") = "", "BEGINNING BALANCE", dic.Item("description"))
