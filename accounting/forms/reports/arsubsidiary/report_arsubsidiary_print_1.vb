...
Public Class report_arsubsidiary_print_1
    ...
    Private Sub noNegative1(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles XrTableCell18.BeforePrint, XrTableCell17.BeforePrint
        ...
        End If
    End Sub
    Private Sub bal_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles cellBalance.BeforePrint
        Dim lbl = CType(sender, XRLabel)
        If lbl.Text <> "" Then
            If Not flag Then
        ...
        End If
    End Sub
    Private Sub noNegative(sender As Object, e As TextFormatEventArgs)
        Dim lbl = CType(sender, XRLabel)
