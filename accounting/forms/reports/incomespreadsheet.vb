...
Public Class incomespreadsheet
    ...
    Private Sub btnExcel_Click(sender As Object, e As EventArgs) Handles btnExcel.Click
        ...
        Dim sql As String = String.Format("SELECT a.account_code,a.account_name,a.chart_group_name,a.chart_class_name " &
",b.debit,b.credit,b.cover_month " &
" FROM selectincomestatement a " &
" LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" LEFT JOIN ( " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,1 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 1 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,2 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 2 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,3 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 3 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,4 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 4 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,5 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 5 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,6 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 6 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,7 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 7 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,8 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 8 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,9 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 9 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,10 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 10 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,11 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 11 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" 	UNION " &
" 	SELECT a.account_id,a.account_code,a.account_name,a.debit,a.credit,a.chart_type,12 AS cover_month " &
" 	FROM selectincomestatement a " &
"   LEFT JOIN {1}.lib_erp_book _book ON _book.book_id = a.book_id " &
" 	WHERE MONTH(a.trans_date) = 12 AND YEAR(a.trans_date) = {0} AND _book.company_id = '{2}' " &
" 	GROUP BY a.account_id " &
" ) b ON b.account_id = a.account_id " & vbNewLine &
"WHERE _book.company_id = '{2}' " & vbNewLine &
"", year_to, _serverDBFS, main.Sys_Default.Rows(0).Item("company_id").ToString)

        If Not withZero Then
            sql &= " AND b.cover_month is not null "
        End If
    ...
    Private Sub generateExcelReport(ByVal listAccount As List(Of Object), ByVal strCol As String, ByVal dicHeader As Dictionary(Of String, String))
        ...
        xlWorkSheet.Cells(2, 1) = "Income Statement Spreadsheet"
