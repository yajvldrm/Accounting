...
Public Class apsubsidiary
    Private module_code As String = "ACC01002"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click, btnExcel.Click
        ...
        col.Add(New KeyValuePair(Of String, String)("@book_unit_no_id", bookUnitIds))
        Dim dt_balance As DataTable = ExecuteWithParameter("get_subsidiary_ledger", ConnectionStringFS, CommandType.StoredProcedure, col)
        ...
        'Dim dt_balance As DataTable = Query(Sql)
        ...
        Select Case range
            ...
            Case "3"
                _Range = String.Format("Range W/ Beginning Balance : {0} - {1}", txt_date_from.Value.ToString("MMMM dd, yyyy"), txt_date_from.Value.ToString("MMMM dd, yyyy"))
        End Select
        'If account = 3 Then
                ...
                Else
                    If groupByBook.Checked Then
                        ...
                        If currency = "2" Then
                            ...
                            End If
                            generateReportExcel(listAccount, colName, dateRange, dicHeader, True, wComparison)
                        Else
                            ...
                            listAccount = groupDataTableToList(ds.Tables("Account"), colName)
                            dicHeader.Item("templateName") = "arapsubsidiary2.xlt"
                            generateReportExcel(listAccount, colName, dateRange, dicHeader, groupByCurrency, False)
                    ...
                    Else
                        If currency = "2" Then
                            ...
                            Else
                                dicHeader.Item("templateName") = "arapsubsidiary2.xlt"
                            End If
                            generateExcelReport(listAccount, colName, dateRange, dicHeader, True, wComparison)
                            'MsgBox("Data Succesfully Load")
                        Else
                            colName = "general_code"
                            Dim groupByCurrency As Boolean = False
                            ...
                            listAccount = groupDataTableToList(ds.Tables("Account"), colName)
                            dicHeader.Item("templateName") = "arapsubsidiary2.xlt"
                            generateExcelReport(listAccount, colName, dateRange, dicHeader, groupByCurrency, False)
                            'MsgBox("Data Succesfully Load")
                        End If
                    End If
                End If
        ...
        End If
    End Sub
    Private Sub generateTabSeparated(ByVal dic As Dictionary(Of String, Object))
            ...
            For Each book In listAccount
                ...
                If fields(1) = "account_code" Then
                    For Each account In book.Item("grouped")
                        ...
                        xlWorkSheet.Cells(4, 5).ColumnWidth = 15
                        ...
                        If withComparison Then
                            xlWorkSheet.Cells(4, 5) = "Debit in Original Amount"
                            xlWorkSheet.Cells(4, 6) = "Credit in Original Amount"
                            If NoRunningBalance.Checked Then
                                xlWorkSheet.Cells(4, 7) = "Debit in " & dicHeader.Item("currencyName")
                                xlWorkSheet.Cells(4, 8) = "Credit in " & dicHeader.Item("currencyName")
                                xlWorkSheet.Cells(4, 7).ColumnWidth = 15
                                xlWorkSheet.Cells(4, 8).ColumnWidth = 15
                                lastColumn = 8
                            Else
                                xlWorkSheet.Cells(4, 7) = "Balance in Original Amount"
                                xlWorkSheet.Cells(4, 8) = "Debit in " & dicHeader.Item("currencyName")
                                xlWorkSheet.Cells(4, 9) = "Credit in " & dicHeader.Item("currencyName")
                                xlWorkSheet.Cells(4, 10) = "Balance in " & dicHeader.Item("currencyName")
                                xlWorkSheet.Cells(4, 8).ColumnWidth = 15
                            ...
                            End If
                        Else
                            xlWorkSheet.Cells(4, 5) = "Debit"
                            xlWorkSheet.Cells(4, 6) = "Credit"
                            If NoRunningBalance.Checked Then
                                lastColumn = 6
                            Else
                                xlWorkSheet.Cells(4, 7) = "Balance"
                                lastColumn = 7
                            End If
                        End If
                        ...
                        xlWorkSheet.Cells(2, 1) = "'" & book.Item("book_name").ToString
                        ...
                        generateTabSeparatedDetailed(dicDetailed)
                        ...
                        xlWorkSheet.Cells(current_row, 5).Value = String.Format("=SUBTOTAL(9,E{0}:E{1})", first_row, current_row - 2)
                        ...
                        If Not NoRunningBalance.Checked Then
                            xlWorkSheet.Cells(current_row, 7).Value = String.Format("=E{0}-F{0}", current_row)
                        End If
                        ...
                        If withComparison Then
                            ...
                            Else
                                ...
                                xlWorkSheet.Cells(current_row, 10).Value = String.Format("=H{0}-I{0}", current_row)
                            End If
        ...
        Else
            ...
            If fields(0) = "account_code" Then
                For Each account In listAccount
                    ...
                    xlWorkSheet.Cells(1, 1) = dicHeader.Item("companyName")
                    xlWorkSheet.Cells(2, 1) = "AP Subsidiary Ledger"
                    xlWorkSheet.Cells(3, 1) = dateRange
        ...
        End If
    End Sub
    Private Sub generateTabSeparatedDetailed(ByRef dic As Dictionary(Of String, Object))
        Dim withComparison As Boolean = dic.Item("withComparison")
        Dim colName As String = dic.Item("colName")
        Dim ds As DataSet = dic.Item("ds")
        Dim listAccount As List(Of Object) = dic.Item("listAccount")
        ...
        If Not isDetailed Then
            ...
            For Each item In listAccount
                ...
                generateTabSeparatedDetailed(dic)
                ...
                If field <> "currency_name" Then
                    ...
                    xlWorkSheet.Cells(current_row, 5).Value = String.Format("=SUBTOTAL(9,E{0}:E{1})", myFirstRow, (current_row - 1))
        ...
        Else
            ...
            For Each i In listAccount
                ...
                xlWorkSheet.Cells(current_row, 5) = debit
                xlWorkSheet.Cells(current_row, 6) = credit
                If Not NoRunningBalance.Checked Then
                    xlWorkSheet.Cells(current_row, 7) = balance
                End If
                If withComparison Then
                    If NoRunningBalance.Checked Then
                        xlWorkSheet.Cells(current_row, 7) = debit_based
                        xlWorkSheet.Cells(current_row, 8) = credit_based
                    Else
                        xlWorkSheet.Cells(current_row, 8) = debit_based
                        xlWorkSheet.Cells(current_row, 9) = credit_based
                        xlWorkSheet.Cells(current_row, 10) = balance_based
                    End If
                End If
                ExcelRange(xlWorkSheet, current_row, 1).NumberFormat = "mm/dd/yyyy"
                ExcelRange(xlWorkSheet, current_row, 5,, lastCol).NumberFormat = "#,##0.00_);(#,##0.00)"
                current_row += 1
            Next
            dic.Item("current_row") = current_row
        End If
    ...
    End Function
    Private Sub generateReportExcel(ByVal listAccount As List(Of Object), ByVal colName As String, ByVal dateRange As String, ByVal dicHeader As Dictionary(Of String, String), Optional originalCurrency As Boolean = False, Optional compare As Boolean = False)
        Dim ctr As Integer = 0
        Dim xlApp As Excel.Application
        Dim xlWorkBook As Excel.Workbook
        Dim xlWorkSheet As Excel.Worksheet
        ...
        For Each g In listAccount
            ...
            xlWorkSheet.Cells(1, 1) = dicHeader.Item("companyName")
            xlWorkSheet.Cells(1, 2) = "'" & g.Item("book_name").ToString
            xlWorkSheet.Cells(3, 1) = dateRange
            ...
            xlWorkSheet.Cells(current_row, 6).Value = String.Format("=SUBTOTAL(9,F{0}:F{1})", first_row, current_row - 2)
            If Not NoRunningBalance.Checked Then
                xlWorkSheet.Cells(current_row, 7).Value = String.Format("=F{0}-E{0}", current_row)
            End If
            ExcelRange(xlWorkSheet, current_row, 5,, lastCol).NumberFormat = "#,##0.00_);(#,##0.00)"
            ...
            If compare Then
                ...
                Else
                    xlWorkSheet.Cells(current_row, 8).Value = String.Format("=SUBTOTAL(9,H{0}:H{1})", first_row, current_row - 2)
                    xlWorkSheet.Cells(current_row, 9).Value = String.Format("=SUBTOTAL(9,I{0}:I{1})", first_row, current_row - 2)
                    xlWorkSheet.Cells(current_row, 10).Value = String.Format("=I{0}-H{0}", current_row)
                End If
                ExcelRange(xlWorkSheet, current_row, 8,, lastCol).NumberFormat = "#,##0.00_);(#,##0.00)"
                xlWorkSheet.Range(xlWorkSheet.Cells(current_row, 1), xlWorkSheet.Cells(current_row, lastCol)).Font.Bold = True
                xlWorkSheet.Range(xlWorkSheet.Cells(current_row, 1), xlWorkSheet.Cells(current_row, lastCol)).Borders(Excel.XlBordersIndex.xlEdgeTop).LineStyle = Excel.XlLineStyle.xlContinuous
                xlWorkSheet.Range(xlWorkSheet.Cells(current_row, 1), xlWorkSheet.Cells(current_row, lastCol)).Borders(Excel.XlBordersIndex.xlEdgeTop).Weight = 3
                xlWorkSheet.Range(xlWorkSheet.Cells(current_row, 1), xlWorkSheet.Cells(current_row, lastCol)).Borders(Excel.XlBordersIndex.xlEdgeBottom).LineStyle = Excel.XlLineStyle.xlContinuous
        ...
        Next
    End Sub
    Private Sub generateExcelReport(ByVal listAccount As List(Of Object), ByVal colName As String, ByVal dateRange As String, ByVal dicHeader As Dictionary(Of String, String), Optional originalCurrency As Boolean = False, Optional compare As Boolean = False)
        Dim xlApp As Excel.Application
        Dim xlWorkBook As Excel.Workbook
        Dim xlWorkSheet As Excel.Worksheet
        ...
        generateExcelGroup(xlWorkSheet, listAccount, colName, dicHeader, current_row, current_index, originalCurrency, compare)
        ...
        End If
    End Sub
    Private Sub generateExcelGroup(ByVal xlWorkSheet As Excel.Worksheet, ByVal listAccount As List(Of Object), ByVal colName As String, ByVal dicHeader As Dictionary(Of String, String), ByRef current_row As Integer, ByRef current_index As Integer, Optional originalCurrency As Boolean = False, Optional compare As Boolean = False, Optional groupByBook As Boolean = False)
        Dim fields = colName.Split(",")
        Dim field = fields(current_index)
            ...
            If dicItem.ContainsKey("grouped") Then
                Select Case field
                    Case "currency_name"
                        ...
                        generateExcelGroup(xlWorkSheet, dicItem.Item("grouped"), colName, dicHeader, current_row, current_index, originalCurrency, compare, groupByBook)
                        current_index -= 1
                End Select
            Else
                current_row += 1
                ...
                For Each d In listData
                    ...
                    xlWorkSheet.Cells(current_row, 4) = particulars
                    xlWorkSheet.Range(xlWorkSheet.Cells(current_row, 4), xlWorkSheet.Cells(current_row, 4)).WrapText = False
                    xlWorkSheet.Cells(current_row, 5) = dic.Item("debit")
                    xlWorkSheet.Cells(current_row, 6) = dic.Item("credit")
                    If Not NoRunningBalance.Checked Then
                        xlWorkSheet.Cells(current_row, 7) = balance
                    End If
                    If groupByBook Then
                        xlWorkSheet.Cells(current_row, 5).NumberFormat = "#,##0.00_);(#,##0.00)"
                    ...
                    If compare Then
                        If NoRunningBalance.Checked Then
                            xlWorkSheet.Cells(current_row, 7) = dic.Item("debit_based")
                            xlWorkSheet.Cells(current_row, 8) = dic.Item("credit_based")
                        Else
    ...
    Private Sub btnPrintOption_Click(sender As Object, e As EventArgs) Handles btnPrintOption.Click
        ...
        End If
    End Sub
    Private Sub apsubsidiary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub loadBookUnit(ByVal id() As String)
        ...
        Dim sql As String = String.Format("SELECT False AS sel2,b.book_id,c.book_code,c.book_name,d.book_unit_no_name,d.book_unit_no_id " & vbNewLine &
            ...
            "", _serverDBFS)
        dss.Tables("lib_erp_book_unit_no").Clear()
        ...
        If id.Length > 0 Then
            ...
            ORDER BY d.book_unit_no_name DESC "
            Dim dt As DataTable = Query(sql)
            For Each row As DataRow In dt.Rows
                dss.Tables("lib_erp_book_unit_no").ImportRow(row)
            Next
        Else
            sql &= String.Format("WHERE c.book_id IN ({0}) AND c.company_id = '{0}'", main.Sys_Default.Rows(0).Item("company_id").ToString())
            sql &= String.Format(" ORDER BY d.book_unit_no_name DESC ")
        End If
        bsBookUnit.DataSource = dss.Tables("lib_erp_book_unit_no")
    ...
    Private Sub checkAllBookUnit_CheckedChanged(sender As Object, e As EventArgs) Handles checkAllBookUnits.CheckedChanged
