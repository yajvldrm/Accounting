...
Public Class aragingsummary
    Private module_code As String = "ACC01007"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click, btnExcel.Click
        ...
        col.Add(New KeyValuePair(Of String, String)("@validation", "AR"))
        ...
        Dim _name As String = "AGING SUMMARY OF ACCOUNTS RECEIVABLE"
        ...
        Else
            Try
                ...
                dicHeader.Add("reportName", "AGING SUMMARY OF ACCOUNTS RECEIVABLE")
    ...
    Private Sub generateReportExcel(ByVal listAccount As List(Of Object), ByVal dicHeader As Dictionary(Of String, String), ByVal strCol As String, ByVal dtAccount As DataTable, ByVal dtAging As DataTable)
        ...
        For Each g In listAccount
            ...
            xlWorkSheet.Cells(5, 3) = "Total"
            xlWorkSheet.Cells(5, 4) = "Current"
    ...
    Private Sub generateExcelReport(ByVal listAccount As List(Of Object), ByVal dicHeader As Dictionary(Of String, String), ByVal strCol As String, ByVal dtAccount As DataTable, ByVal dtAging As DataTable)
        ...
        For i As Integer = 4 To last_column
            xlWorkSheet.Cells(current_row, i).Value = String.Format("=SUM({1}{0}/C{0})", current_row - 1, ConvertToLetter(i))
            xlWorkSheet.Cells(current_row, i).HorizontalAlignment = Excel.Constants.xlRight
            xlWorkSheet.Cells(current_row, i).NumberFormat = "##0.00%"
        Next
        xlWorkSheet.Range(xlWorkSheet.Cells(current_row, 1), xlWorkSheet.Cells(current_row, last_column)).Font.Bold = True
            ...
            Else
                If field = "currency_name" Or field = "general_name" Then
                    If dicItem.ContainsKey("general_name") Then
                        xlWorkSheet.Cells(current_row, 2) = dicItem.Item("general_name")
                    Else
                ...
                For Each d In listData
                    ...
                    xlWorkSheet.Cells(current_row, 3).Value += ifNull(dic.Item("debit_based"), 0)
                    xlWorkSheet.Cells(current_row, 4).Value += ifNull(dic.Item(dicHeader.Item("col_prefix") & "current"), 0)
                    Dim current_column As Integer = 5
                    For Each dr As DataRow In dtAging.Rows
                    ...
                    xlWorkSheet.Range(xlWorkSheet.Cells(current_row, 3), xlWorkSheet.Cells(current_row, last_column)).NumberFormat = "_(* #,##0.00_);_(* (#,##0.00);_(* "" - ""??_);_(@_)"
                    current_column += 1
                    current_row += 1
                Next
            End If
    ...
    Private Sub aragingsummary_Load(sender As Object, e As EventArgs) Handles MyBase.Load
