...
#Region "Events"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_dc_filter_new.journal_id = JournalID
        report_dc_filter_new.book_id = BookID
        report_dc_filter_new.transid = txt_trans_id.Text
        report_dc_filter_new.transno = txt_trans_no.Text
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        End If
        computeTotal()
        Dim tmp_debit = ds.Tables("jbooks").Compute("sum(debit)", "deleted = 'False' AND noCompute = 'False'")
...
#End Region
    ...
    Private Sub transactiondc_Load(sender As Object, e As EventArgs) Handles MyBase.Load
