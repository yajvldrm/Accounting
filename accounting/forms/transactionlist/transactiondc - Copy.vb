...
#Region "Variable Declaration"
    ...
    Private module_code As String = "ACC00701"
...
#Region "Other Functions/Subs"
    Friend Sub initializeDecimalPlaces(ByVal strNumberFormat As String)
        ...
        txt_exchange_rate_det.NumberFormat = strNumberFormat
        txt_based_rate_det.NumberFormat = strNumberFormat
    ...
    Friend Sub loadLastTransaction(Optional pageNumber As Integer = 0)
        ...
        ",IFNULL(_lock.isLock,0) AS isLock " & vbNewLine & _
        "FROM trans_header a " & _
        "LEFT JOIN selectTransactionLocking _lock ON _lock.trans_id = a.trans_id " & vbNewLine & _
        ...
        "WHERE a.journal_id = '{1}' AND a.book_id = '{2}' AND DATE_FORMAT(a.trans_date,'%Y-%m') = '{3}-{4}' " & _
        "ORDER BY a.trans_no ASC " & _
        ...
        If myDataTable.Rows.Count > 0 Then
            ...
            txt_amount_in_word.Text = amount_words(txt_amount.DecimalValue)
            computeTotal()
    ...
    Friend Sub init()
        ...
        If main.Sys_Default.Rows(0)("line_currency") = 0 Then
            ...
            txt_exchange_rate_det.Visible = False
            txt_based_rate_det.Visible = False
            For Each obj As Control In det.Controls
                obj.Top -= 23
            Next
            det.Height -= 23
        ...
        If main.Sys_Default.Rows(0)("w_alloc") = 0 And main.Sys_Default.Rows(0)("w_proj") = 0 And main.Sys_Default.Rows(0)("w_dept") = 0 Then
            ...
            Me.Height -= 23
        End If
        Dim sql As String = String.Format("SELECT COUNT(a.approval_id) AS numRow " & _
    ...
    Private Sub clear_control()
        ...
        ds.Clear()
        lbldebittotal.Text = Format(0, txt_debit.NumberFormat)
        lblcredittotal.Text = Format(0, txt_debit_based.NumberFormat)
        lbldifftotal.Text = Format(0, txt_debit.NumberFormat)
        lbldebitbasedtotal.Text = Format(0, txt_debit_based.NumberFormat)
        lblcreditbasedtotal.Text = Format(0, txt_credit_based.NumberFormat)
        lbldiffbasedtotal.Text = Format(0, txt_debit.NumberFormat)
    ...
    Private Sub enable_control()
        ...
        Dim dr As DataRow = main.Sys_Default_Det.Select("module_code = 'ACC00201'")(0)
    ...
    Private Sub enable_control_det()
        If txt_based_rate.DecimalValue = 0 Then
    ...
    Private Sub computeTotal()
        ...
        lbldebittotal.Text = Format(dtot, txt_debit.NumberFormat)
        lblcredittotal.Text = Format(ctot, txt_debit_based.NumberFormat)
        lbldifftotal.Text = Format(diff, txt_debit.NumberFormat)
        ...
        lbldebitbasedtotal.Text = Format(dbtot, txt_debit_based.NumberFormat)
        lblcreditbasedtotal.Text = Format(cbtot, txt_credit_based.NumberFormat)
        lbldiffbasedtotal.Text = Format(diffb, txt_debit_based.NumberFormat)
    End Sub
#End Region
#Region "Events"
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_dc_filter.journal_id = JournalID
        report_dc_filter.book_id = BookID
        report_dc_filter.transid = txt_trans_id.Text
        report_dc_filter.transno = txt_trans_no.Text
        report_dc_filter.ShowDialog()
    End Sub
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txt_trans_no.Text = "" Then
            ...
            Exit Sub
        Else
            Dim sql_test_trans_no = String.Format("SELECT trans_no AS existing FROM trans_header WHERE trans_no = '{0}' AND trans_id <> '{1}'", txt_trans_no.Text, txt_trans_id.Text)
            Dim dt_test_rans_no As DataTable = Query(sql_test_trans_no)
            If dt_test_rans_no.Rows.Count > 0 Then
                MsgBox("Transaction Number Already Exist. A new transaction number will automatically generate.")
        ...
        If txt_currency_id.Text = "" Then
            ...
            Exit Sub
        End If
        If txt_exchange_rate.DecimalValue = 0 Then
        ...
        fields.Add("exchange_rate", txt_exchange_rate.DecimalValue)
        fields.Add("based_rate", txt_based_rate.DecimalValue)
        fields.Add("amount", txt_amount.DecimalValue)
        fields.Add("amount_based", txt_amount_based.DecimalValue)
        ...
        For i = 0 To ds.Tables("jbooks").Rows.Count - 1
            ...
            fields = New Dictionary(Of String, String)
            fields.Add("jbooks_id", dr("jbooks_id").ToString)
            ...
            If dr("ref_jbooks_id").ToString = "" And dr("validation").ToString <> "10" Then
                debit_based = dr("debit") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                credit_based = dr("credit") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
            Else
            ...
            If dr("jbooks_id").ToString = "" Or dr.Item("jbooks_id").ToString.Contains("tmp_") Then
        ...
        If ds.Tables("ewt").Rows.Count > 0 Then
            For i = 0 To ds.Tables("ewt").Rows.Count - 1
                ...
                If dr("ref_ewt_id").ToString = "" Then
                    amount_based = dr("amount") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                    tax_amount_based = dr("tax_amount") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                    debit_based = dr("debit") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                    credit_based = dr("credit") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                Else
                ...
                Else
                    ...
                    Else
                        ...
                        qry = ATGenerateQuery("Update", "trans_jbooks_ar", fields, Environment.MachineName, Environment.UserName, main.log_id, dr.Item("ewt_id").ToString, "ewt_id")
                    End If
                End If
                If qry <> "" Then
                    dt = Query(qry)
        ...
        If ds.Tables("input_vat").Rows.Count > 0 Then
            For i = 0 To ds.Tables("input_vat").Rows.Count - 1
                ...
                If dr("ref_input_vat_id").ToString = "" Then
                    gross_amount_based = dr("gross_amount") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                    vat_amount_based = dr("vat_amount") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                    net_amount_based = dr("net_amount") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                    debit_based = dr("debit") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                    credit_amount_based = dr("credit") * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
                Else
    ...
    Private Sub btnInsert_Click(sender As Object, e As EventArgs) Handles btnInsert.Click
        ...
        enable_control_det()
        NewControls.clearControl(det)
        txt_tmp_jbooks_id.Text = Now.ToString("yyyyMMddHHmmss")
        txt_account_id.Focus()
        txt_currency_id_det.Value = txt_currency_id.Value
        txt_currency_id_det.Text = txt_currency_name.Text
        txt_exchange_rate_det.DecimalValue = txt_exchange_rate.DecimalValue
        txt_based_rate_det.DecimalValue = txt_based_rate.DecimalValue
            ...
            If selectedRow.Cells("offset").Value > 0 Then
                ...
                If "23".Contains(selectedRow.Cells("validation").Value.ToString) Then
                    ...
                    If txt_debit.DecimalValue = 0 And txt_credit.DecimalValue = 0 Then
                        transmodedet = "update"
                        txt_account_id.Focus()
                    ElseIf txt_debit.DecimalValue <> 0 Then
    ...
    Private Sub btnOK_Click(sender As Object, e As EventArgs) Handles btnOK.Click
        ...
        Else
            ...
            If selectedRow.Cells("validation").Value = "2" Then 'debit,ar
                If txt_debit.DecimalValue < selectedRow.Cells("minimum").Value Then
                    MsgBox("Unable to Save. Debit is lower than the expected value.")
                    Exit Sub
                End If
            End If
            If selectedRow.Cells("validation").Value = "3" Then 'credit,ap
                If txt_credit.DecimalValue < selectedRow.Cells("minimum").Value Then
        ...
        dr("debit") = txt_debit.DecimalValue
        dr("credit") = txt_credit.DecimalValue
        dr("debit_based") = txt_debit_based.DecimalValue
        dr("credit_based") = txt_credit_based.DecimalValue
        ...
        If v = "2" Or v = "3" Then
            ...
            End If
        End If
        dr("dc") = IIf(txt_debit.DecimalValue <> 0, 1, 2)
        If (txt_credit.DecimalValue = 0 And txt_debit.DecimalValue = 0) Or (txt_debit_based.DecimalValue = 0 And txt_credit_based.DecimalValue = 0) Then
        ...
        End If
        If transmodedet = "insert" Then
            If recordExist(dgjbooks, {"account_id", txt_account_id.Value}, {"debit", "credit"}, {txt_debit.DecimalValue, txt_credit.DecimalValue}) Then
        ...
        End If
        computeTotal()
        Dim tmp_debit = ds.Tables("jbooks").Compute("sum(debit)", "deleted = 'False'")
        txt_amount.DecimalValue = If(tmp_debit.ToString = "", 0, tmp_debit)
        txt_amount_based.DecimalValue = txt_amount.DecimalValue * (txt_exchange_rate.DecimalValue / txt_based_rate.DecimalValue)
        txt_amount_in_word.Text = amount_words(txt_amount.DecimalValue)
        Dim dt As DataTable = ds.Tables("jbooks")
        Dim newDt As New DataTable("tmp_jbooks")
        For Each col As DataColumn In dt.Columns
    ...
    Private Sub txt_currency_id_Leave(sender As Object, e As EventArgs) Handles txt_currency_id.Leave
        If txt_currency_id.RowData IsNot Nothing Then
            ...
            txt_exchange_rate_det.DecimalValue = dr.Item("exchange_rate")
            txt_based_rate_det.DecimalValue = dr.Item("based_rate")
        End If
    End Sub
    Private Sub txt_currency_id_det_Leave(sender As Object, e As EventArgs) Handles txt_currency_id_det.Leave
        If txt_currency_id.RowData IsNot Nothing Then
            ...
            txt_exchange_rate_det.Text = dr.Item("exchange_rate")
            txt_based_rate_det.Text = dr.Item("based_rate")
        End If
    End Sub
    ...
    Private Sub txt_terms_id_det_Leave(sender As Object, e As EventArgs) Handles txt_terms_id_det.Leave
        ...
        End If
    End Sub
    Private Sub txtdebit_Leave(sender As Object, e As EventArgs) Handles txt_debit.Leave
        If txt_debit.Enabled Then
            Dim v As Integer = 0
            Dim flag As Boolean = False
            Dim tmp_rowData = txt_account_id.RowData
            If txt_debit.DecimalValue <> 0 Then
            ...
            End If
            If v <> 3 Then
                txt_debit_based.DecimalValue = txt_debit.DecimalValue * (txt_exchange_rate_det.DecimalValue / txt_based_rate_det.DecimalValue)
            ...
            If "456789".IndexOf(v.ToString) >= 0 Then
                ...
                If txt_debit.DecimalValue > 0 Or txt_credit.DecimalValue > 0 Then
                End If
            End If
        End If
    End Sub
    Private Sub txtdebitbased_Leave(sender As Object, e As EventArgs) Handles txt_debit_based.Leave
        If txt_debit_based.DecimalValue <> 0 Then
            txt_credit_based.DecimalValue = 0
        End If
    End Sub
    Private Sub txtcredit_Leave(sender As Object, e As EventArgs) Handles txt_credit.Leave
        If txt_credit.Enabled Then
            Dim v As Integer = 0
            Dim flag As Boolean = False
            Dim tmp_rowData = txt_account_id.RowData
            If txt_credit.DecimalValue <> 0 Then
        ...
        End If
    End Sub
    Private Sub txtcreditbased_Leave(sender As Object, e As EventArgs) Handles txt_credit_based.Leave
        If txt_credit_based.DecimalValue <> 0 Then
            txt_debit_based.DecimalValue = 0
        End If
    End Sub
    ...
    Private Sub btnParticular_Click(sender As Object, e As EventArgs) Handles btnParticular.Click
        ...
        trans_particular.TransactionName = "Debit / Credit Memo"
