...
Public Class transactionpc
    ...
    Friend Sub refresh_record()
        ...
        If dt.Rows.Count > 0 Then
            ...
            txttranspcid.Text = dt.Rows(0).Item("trans_pc_id").ToString
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_pc_filter.journal_id = journal_id
        report_pc_filter.book_id = book_id
        report_pc_filter.transid = txttransid.Text
        report_pc_filter.transno = txttransno.Text
        report_pc_filter.ShowDialog()
    End Sub
    ...
    Private Sub transactionpc_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
