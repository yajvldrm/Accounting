...
Public Class transactionjb
    ...
    Private Sub txtgeneral_Leave(sender As Object, e As EventArgs) Handles txtgeneral.Leave
        ...
        Dim sql As String = "select * from lib_erp_general WHERE general_type = 2 OR general_type = 3 "
    ...
    Private Sub txtaccount_Leave(sender As Object, e As EventArgs) Handles txtaccount.Leave
        ...
        Dim sql As String = "select * from lib_erp_chart"
        Dim dt As DataTable = FsQuery(sql)
        If dt.Rows.Count = 0 Then
            MsgBox("No record found.")
        Else
    ...
    Private Sub txtproject_Leave(sender As Object, e As EventArgs) Handles txtproject.Leave
        ...
        Dim sql As String = "select * from lib_erp_project"
        Dim dt As DataTable = FsQuery(sql)
        If dt.Rows.Count = 0 Then
            MsgBox("No record found.")
        Else
    ...
    Private Sub txtdepartment_Leave(sender As Object, e As EventArgs) Handles txtdepartment.Leave
        ...
        Dim sql As String = "select * from lib_erp_department"
        Dim dt As DataTable = FsQuery(sql)
        If dt.Rows.Count = 0 Then
            MsgBox("No record found.")
        Else
    ...
    Private Sub txtallocation_Leave(sender As Object, e As EventArgs) Handles txtallocation.Leave
        ...
        Dim sql As String = "select a.* from lib_erp_allocation a inner join lib_erp_allocation_account b on a.allocation_id = b.allocation_id where b.account_id = " & txtaccount.Value
        Dim dt As DataTable = FsQuery(sql)
        If dt.Rows.Count = 0 Then
            MsgBox("No record found.")
        Else
    ...
    Friend Sub refresh_record()
        ...
        If dt.Rows.Count > 0 Then
            ...
            'txttransjbid.Text = dt.Rows(0).Item("trans_jb_id").ToString
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_jb_filter.journal_id = journal_id
        report_jb_filter.book_id = book_id
        report_jb_filter.transid = txttransid.Text
        report_jb_filter.transno = txttransno.Text
        report_jb_filter.ShowDialog()
    End Sub
    ...
    Private Sub transactionjb_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub transactionjb_Load(sender As Object, e As EventArgs) Handles Me.Load
        formload()
    End Sub
