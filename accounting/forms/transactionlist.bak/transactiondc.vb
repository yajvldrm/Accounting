...
Public Class transactiondc
    ...
    Private Sub transactiondc_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
    ...
    Friend Sub refresh_record()
        ...
        If dt.Rows.Count > 0 Then
            ...
            'txttransdcid.Text = dt.Rows(0).Item("trans_dc_id").ToString
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        report_dc_filter.journal_id = journal_id
        report_dc_filter.book_id = book_id
        report_dc_filter.transid = txttransid.Text
        report_dc_filter.transno = txttransno.Text
