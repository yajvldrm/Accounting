...
Public Class transactioncr
    ...
    Friend Sub refresh_record()
        ...
        If dt.Rows.Count > 0 Then
            ...
            txttranscrid.Text = dt.Rows(0).Item("trans_cr_id").ToString
    ...
    Private Sub btnApprove_Click(sender As Object, e As EventArgs) Handles btnApprove.Click, btnComment.Click, btnCorrection.Click
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        For Each dr As DataRow In ds.Tables("jbooks").Rows
            If dr("jbooks_id") = "" Then
                Dim tmp_index = dr.Table.Rows.IndexOf(dr)
                If tmp_index <= dt.Rows.Count Then
                    jbooks_id = dt.Rows(tmp_index)("jbooks_id")
                End If
            Else
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        report_cr_filter.trans_no = txttransno.Text
    ...
    Private Sub transactioncr_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
